...
export const AGGREGATIONS_LABELS = {
  ...
  "sum": "Сумма",
  "csv": "CSV",
  "csvDistinct": "CSV (уник.)",
}

export const SCALES_LABELS = {
  "sequential": "Последовательный",
  "diverging": "Расходящий",
  "ordinal": "Порядковый"
}

export const COLOR_SCHEMES_LABELS = {
  "interpolateBlues": "Синяя последовательная",
  "interpolateGreens": "Зелёная последовательная",
  "interpolateReds": "Красная последовательная",
  "interpolateRdBu": "Красно-синяя расходящаяся",
  "interpolateBrBG": "Коричнево-бирюзовая расходящаяся",
  "interpolatePiYG": "Розово-зелёная расходящаяся",
  "schemeCategory10": "Категория 10",
  "interpolateTurbo": "Турбо дискретная",
  "interpolateSpectral": "Спектрально дискретная"
}