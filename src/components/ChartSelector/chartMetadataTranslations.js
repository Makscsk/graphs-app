...
export function translateChartMetadata(chart) {
  ...
  if (newMetadata.description && descriptionTranslations[newMetadata.description]) {
  ...
  if (Array.isArray(newMetadata.categories)) {
    newMetadata.categories = newMetadata.categories.map(cat => categoryTranslations[cat] || cat);
  }
